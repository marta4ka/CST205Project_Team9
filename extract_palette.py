...
def extract_colors(uploaders_image, outline_width, palette_length_div, outline_color, color_count=10):
    ...
    list_of_colors = colors_for_palette.getcolors(80*80)
    ...
    for amount_of_colors, unique_color in list_of_colors:
